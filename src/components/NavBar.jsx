  ...
  <>
      ...
      <header className="flex items-center justify-between bg-black xl:justify-start w-full py-4 px-8 h-[10vh] z-50">
        <div className="flex pxl:w-1/6 text-center -mt-4">
                  ...
                  <a href="#" className="text-2xl font-bold relative p-1 bg-black text-white">
                  <Link to={"/"}>
        ...
        > 
          ...
          <ul
              ...
              <li>
                <a
                  className="block w-full whitespace-nowrap bg-transparent px-9 py-2 text-sm font-normal text-neutral-700 hover:bg-neutral-100 active:text-neutral-800 active:no-underline disabled:pointer-events-none disabled:bg-transparent disabled:text-neutral-400 dark:text-neutral-200 dark:hover:bg-neutral-600"
                  href="#"
